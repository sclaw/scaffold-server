...
module Database.Migration.Version.Version18 (sql) where

import Data.String.Interpolate

sql :: String
sql = [i|delete from "edgeNode"."QualificationProvider";
        ...
        array_to_json(array_agg(json_build_object('grade', json_build_object('Right', json_build_object('value', json_build_object('integral', i))), 'rank', i))) 
        ...
        array_to_json(array_agg(json_build_object('grade', json_build_object('Right', json_build_object('value', json_build_object('text', x))), 'rank', i))) 
